...
public class CercaProjectManagerFrame extends JFrame {
	...
	public CercaProjectManagerFrame(Controller c) {
		...
		layeredPane.setBounds(10, 32, 257, 242);
		...
		textFieldMinSalario.setBounds(49, 139, 68, 20);
		panelAttributi.add(textFieldMinSalario);
		
		textFieldMaxSalario = new JTextField();
		textFieldMaxSalario.setBounds(139, 139, 68, 20);
		...
		labelMin.setBounds(10, 142, 32, 14);
		...
		labelMax.setBounds(215, 142, 32, 14);
		...
		labelValutazione.setBounds(10, 197, 68, 14);
		...
		textFieldMaxValutazione.setBounds(139, 211, 68, 20);
		...
		labelMax_1.setBounds(215, 214, 32, 14);
		panelAttributi.add(labelMax_1);
		
		checkboxMinSalario = new JCheckBox("Salario medio");
		checkboxMinSalario.setBounds(10, 166, 107, 23);
		...
		checkboxMaxSalario.setBounds(139, 166, 108, 23);
		...
		layeredPane.add(panelMeeting, "name_264307231112900");
		...
		scrollPane.setBounds(0, 300, 464, 156);
		...
		buttonConferma.setBounds(106, 467, 242, 23);
		...
		buttonRicerca.setBounds(335, 270, 104, 23);
