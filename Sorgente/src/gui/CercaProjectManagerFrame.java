			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					case "Attributi":
						...
						PopolaTabella(controller.RicercaProjectManagerPerAttributi(codf, nome, cognome, minSalario, maxSalario));
						break;
					case "Progetti a cui partecipa":
						...
						PopolaTabella(controller.RicercaProjectManagerPerProgetti(codp, tipologia, ambito, ruolo, minProgetti, maxProgetti));
						break;
					}
				}
				catch (SQLException ex) {
